...
import DatabaseFaq from "./DatabaseFaq";
import DatabaseExploreCourseDetails from "./DatabaseExploreCourseDetails";

const FinalDatabaseExploreCourse = () => {
  const courseJSONLD = {
...
export default FinalDatabaseExploreCourse;
