...
import FullstackExploreCourseDetails from "./FullstackExploreCourseDetails";

const FinalFullstackExploreCourse = () => {
  const courseJSONLD = {
...
export default FinalFullstackExploreCourse;
