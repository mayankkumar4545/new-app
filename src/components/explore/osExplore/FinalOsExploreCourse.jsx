...
import OsFaq from "./OsFaq";
import OsExploreCourseDetails from "./OsExploreCourseDetails";

const FinalOsExploreCourse = () => {
  const courseJSONLD = {
...
export default FinalOsExploreCourse;
