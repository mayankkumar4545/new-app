...
import PythonExploreCourseDetails from "./PythonExploreCourseDetails";

const FinalPythonExploreCourse = () => {
  const courseJSONLD = {
...
export default FinalPythonExploreCourse;
