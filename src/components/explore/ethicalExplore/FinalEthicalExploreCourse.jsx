...
import EthicalFaq from "./EthicalFaq";
import EthicalExploreCourseDetails from "./EthicalExploreCourseDetails";

const FinalEthicalExploreCourse = () => {
  const courseJSONLD = {
...
export default FinalEthicalExploreCourse;
