...
import AngularExploreCourseDetails from "./AngularExploreCourseDetails";

const FinalAngularExploreCourse = () => {
  const courseJSONLD = {
...
export default FinalAngularExploreCourse;
