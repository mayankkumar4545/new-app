...
import ACFExploreCourseDetails from "./ACFExploreCourseDetails";
import InstructorBio from "./InstructorBio"; // Import the new component
import TargetAudience from "./TargetAudience"; // Import the new component

const FinalACFExploreCourse = () => {
  const courseJSONLD = {
  ...
  return (
    <>
      ...
      {/* Main course details */}
      <ACFExploreCourseDetails />

      {/* New Authority-Building Components */}
      {/*<div className="authority-section-container">
        <TargetAudience />
        <InstructorBio />
      </div>*/}
...
export default FinalACFExploreCourse;
